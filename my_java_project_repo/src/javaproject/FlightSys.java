...
public class FlightSys {
    ...
    public static boolean addFlight(String flightType, String flightId, String flighDateTime, String fToD, int gate, double price, String tcNo, String passportId, double cargoWeight,String seat,String nameSurname) {
        DomesticFlight dF;
